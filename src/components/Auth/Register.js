        ...
        <form action="#" class="signup-form" autoComplete='off' autoSave='on'>
          <div class="form-group row">
            <div className="col-12 col-md-6 col-lg-6">
              ...
              <input type="text" id='first_namer' class="form-control" placeholder="enter first name" />
            </div>
          ...
          <div class="form-group row">
            <div className="col-12 col-md-6 col-lg-6">
              ...
              <input type="tel" id='phone_number' class="form-control" placeholder="enter phone number" />
            </div>
            <div className="col-12 col-md-6 col-lg-6">
