      ...
      <div className="container-fluid">
        ...
        <div className="row text-center">
          <div className="col-12 col-lg-5 col-md-6 py-2">
            ...
            >
              Whapi.io is in no way affiliated with, authorized, maintained,
              sponsored or endorsed by WhatsApp or any of its affiliates or
              subsidiaries. This is an independent and unofficial software. Do
              not use this service to send spam or bulk messages. Use at your
              own risk.
            </p>
          </div>
          ...
          <form
            action="/"
            autoComplete="off"
            className="col-12 col-lg-3 col-md-6 py-2"
          >
